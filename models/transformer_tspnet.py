...
from .transformers.tsptransformer_decoder import TransformerDecoder 
import pdb
...
class TransformerNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # Backbone 
        for t in self.tasks:
            _,selected_fea = self.backbone(x, t)
            selected_fealist[t] = selected_fea
        
        # transformer decoder
        task_features, inter_preds = self.multi_task_decoder(selected_fealist)
